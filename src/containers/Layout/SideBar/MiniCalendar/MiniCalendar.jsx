...
import { MinicalendarStyle } from "./index.style";
  ...
  return (
    <MinicalendarStyle>
      <div className="wrapper">
        ...
        <header>
          <div className="icons">
            <span id="prev" className="material-symbols-rounded" onClick={prev}>
              chevron_left
            </span>
          </div>
          ...
          <div className="icons">
            <span id="next" className="material-symbols-rounded" onClick={next}>
              chevron_right
            </span>
          </div>
        </header>
        <div className="miniCalendar">
          ...
          <ul className="days">
            {days.map((day, index) => {
              return (
                <li
                  className={daysActiveArray[index]}
                  onClick={(e) => getDate(day, index)}
                >
                  {day}
                </li>
              );
